...
async function seed() {
  ...
  const products = await Promise.all([
    Product.create({
      name: 'Mint Green Tea',
      price: 8.50,
      description: 'In Morocco and many other Arab countries, serving mint tea has come to represent a certain lifestyle and the most refined expression of hospitality. Green tea is always used, usually Gunpowder, which is known for its refreshing and thirst quenching qualities. Chinese green tea (Gunpowder) rolled into pearls and flavored with dried mint leaves. Astringent, fresh and thirst quenching.',
      imageUrl: 'https://us.palaisdesthes.com/pub/media/catalog/product/cache/c687aa7517cf01e65c009f6943c2b1e9/8/1/815-42140-idd04ibnlv.jpg',
      status: 'available'
    }),
    Product.create({
      name: 'Thé du Hammam',
    ...
    Product.create({
      ...
      imageUrl: 'https://us.palaisdesthes.com/pub/media/catalog/product/cache/c687aa7517cf01e65c009f6943c2b1e9/9/1/918-36013-w4516dmwwb.jpg',
      status: 'available'
    }),
    Product.create({
      name: 'Chai Imperial Black Tea',
      price: 8.50,
      description: 'Loved by our customers, the Chai n°25 recipes becomes a permanent reference! Inspired by the Indian tradition of spiced tea, Chai Impérial is a delicate black tea pepped up with a generous blend of green cardamom, pink peppercorns, cinnamon, ginger, and orange zest. Full of precious spices, Chai Imperial is a delicious and warm blend which can be prepared nature or with milk like in the Indian tradition.',
      imageUrl: 'https://us.palaisdesthes.com/pub/media/catalog/product/cache/c687aa7517cf01e65c009f6943c2b1e9/7/7/771-34801-v9p8uywm6p.jpg',
      status: 'available'
    }),
    Product.create({
      name: 'Japanese Superfood for Relaxation',
      price: 8.50,
      description: 'Japanese Superfood is a delicious recipe combining the detox benefits of Sencha green tea, spirulina, and buckwheat with soothing notes of nashi pear. This perfect choice for a relaxing break can be enjoyed both hot and iced. In Japanese culture, it is important to take time for oneself, to re-centre one’s thoughts and protect oneself against the daily turmoil and stress, which are considered toxic. In Japan, purifying the body means seeking relaxation.',
    ...
    Product.create({
      ...
      price: 8.50,
      description: 'Thé des Sources is a highly refreshing blend made of Chinese green tea, bergamot and mint leaves. Perfect as a thirst-quenching drink.',
      imageUrl: 'https://us.palaisdesthes.com/pub/media/catalog/product/cache/c687aa7517cf01e65c009f6943c2b1e9/8/5/857-42194-crcj7y9ko9.jpg',
      status: 'available'
    }),
    Product.create({
      name: 'Théophile Green Tea',
      price: 8.50,
      description: 'Palais des Thés celebrates Asian traditions with a deliciously exotic creation. This green tea, with fruity accents of lychee and mango spiced up with lotus flowers, can be enjoyed both hot and iced. Try it today!',
      imageUrl: 'https://us.palaisdesthes.com/pub/media/catalog/product/cache/c687aa7517cf01e65c009f6943c2b1e9/8/8/887-42218-gpaci7mu1a.jpg',
      status: 'available'
    }),
    Product.create({
      name: 'Thé des Concubines',
      price: 8.50,
      description: 'Recreate the unique, welcoming atmosphere of a Chinese tea house. This rare tea is a refined, delicate blend of green and black teas from China with rich, fruity notes of cherry, mango and vanilla. Contains rose petals and fruit pieces.',
      imageUrl: 'https://us.palaisdesthes.com/pub/media/catalog/product/cache/c687aa7517cf01e65c009f6943c2b1e9/8/6/864_1.jpg',
      status: 'available'
    }),
    Product.create({
      name: 'Pear Green Tea',
      price: 8.50,
      description: 'Rediscover the classic fragrances of tea with our pear tea!\nA green tea from China\nWith sweet scents of pear\nAll-natural extracts\nDiscover a tea flavored with a unique fragrance taken directly from nature: pear. This tea marries the freshness of fine green teas, Mao Feng, harvested in China, with the sweet scents and caramelised nuances of pear. Sweet and delicious!\nEach box is decorated with delicate watercolour-like touches of crunchy green. Contains 3.5oz / 100g of tea. Delightful with milk chocolate!',
 ...
 Product.create({
      ...
      imageUrl: 'https://us.palaisdesthes.com/pub/media/catalog/product/cache/c687aa7517cf01e65c009f6943c2b1e9/c/2/c237_c238-45342-bc4d3dhe0e.jpg',
      status: 'available'
    }),
  ])
